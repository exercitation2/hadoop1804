(function () {
    ...
    var cookieUtils = {
        ...
        set : function (cookieName,cookieValue) {
            ...
            //获取累计十年的时间
            var tenYearsTime = 10 * 365 * 24 * 60 *60 * 1000;

            //十年后的时间
            var tenYearAfter = currentTime + tenYearsTime;
    ...
    var tracker = {
        clientConfig:{
            logServerUrl:"http://hadoop-11/log.gif",//日志服务器地址
        ...
        cookieKeys:{
            uuid:"uid",//用户唯一标识
            sid:"sid",//会话id
            perVisitTime:"pre_visit_time"//用户最近一次访问时间,
        },
